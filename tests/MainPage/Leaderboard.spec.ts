...
test.describe('LeaderBord page', async()=>{
    ...
    for(const{brand, user} of LeaderbordParams){
        ...
        await test.step('Check visibility of user profiles with filter This week', async()=>{
            ...
            let filters = ['Top Earners','Top Earners on Cryptos','Top Earners on Gold','Top Earners on Silver','Top Earners on DAX','Top Earners on NASDAQ','Top Earners on Ether','Top Earners on Bitcoin','Top Earners on Crude Oil','Top Earners on Brent Oil','Top Earners on Dow Jones','Most Popular Leaders','Trending Leaders']
